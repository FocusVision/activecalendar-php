...
<p><span class="phead">Examples: </span>An index of the examples scripts located under <a href="data/" target="_blank"><img src="data/img/folder.png" alt="" border="0" /> /data</a> <span class="small">(opens a new browser window)</span> can be found at <a href="examples.php"><img src="data/imgphp.png" alt="" border="0" /> examples.php</a>. Use the examples first to get an idea of the usage of the Active Calendar Project by viewing the source code and using various CSS files.</p>
...
<p><span class="phead">Source code: </span>The source code of the PHP class and its subclass(es) can be found at <a href="source/" target="_blank"><img src="data/img/folder.png" alt="" border="0" /> </a> <span class="small">(opens a new browser window)</span>.</p>
